...
public class JobController {
  ...
  public ResponseEntity<JobResponse> getAllJobs(
    ...
    if (jobs.isEmpty()) {
      return new ResponseEntity<>(new JobResponse(jobs, "Không tìm thấy công việc",HttpStatus.NOT_FOUND), HttpStatus.NOT_FOUND);
    }
  ...
  public ResponseEntity<JobResponse> findJobs(
    ...
    Page<Job> jobs = jobService.findJobsWithFilters(keyword, salaryMin, salaryMax, companyType, jobType, candidateLevel, page, size);
